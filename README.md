...
Acá subo las cosas que hago para aprender go.
...
- [A simple programming environment - Video](https://vimeo.com/53221558)
- [Writing Web Applications - Article](https://go.dev/doc/articles/wiki/)
- [Go Web Examples](https://gowebexamples.com/)

### CLI

- [Building an Awesome CLI App in Go - Article](https://spf13.com/presentation/building-an-awesome-cli-app-in-go-oscon/)
